...
class TournamentManager:
    def __init__(self, client, agent, db=None):
        ...
        # Set check interval to 4 hours (14400 seconds) to catch daily/new free tournaments
    ...
    async def get_all_active_free_tournaments(self) -> List[Dict]:
        ...
        try:
            ...
            # Note: API return keys (entry_fee, status) must match the actual PocketOption API/library.
            free_tournaments = [
